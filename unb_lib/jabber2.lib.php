...
// Modified by Yves Goergen, see "MOD:YG:" comments

if (!defined('UNB_RUNNING')) die('Not a UNB environment in ' . basename(__FILE__));   // MOD: UNB compliance
        ...
        switch (key($xml)) {
            ...
            case 'stream:features':
                ...
                if (isset($xml['stream:features'][0]['#']['mechanisms'][0]['@']['xmlns']) &&
                    ...
                    // MOD:YG: Removed SSL requirement, see http://newsboard.unclassified.de/forum/thread/1608
